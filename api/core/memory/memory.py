        ...
        **Output just the synthesized insights:**
        ...
        if semantic_content:
            tasks.append(("semantic", asyncio.create_task(
                self.llm_service.generate_gpt_response_async(semantic_prompt, temperature=0.7, model_override="gpt-3.5-turbo-instruct")
            )))
        else:
        ...
        if episodic_content:
            tasks.append(("episodic", asyncio.create_task(
                self.llm_service.generate_gpt_response_async(episodic_prompt, temperature=0.7, model_override="gpt-3.5-turbo-instruct")
            )))
        else:
        ...
        if learned_content:
            tasks.append(("learned", asyncio.create_task(
                self.llm_service.generate_gpt_response_async(learned_prompt, temperature=0.7, model_override="gpt-3.5-turbo-instruct")
            )))
        else:
