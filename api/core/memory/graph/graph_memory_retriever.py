...
class GraphMemoryRetriever:
        ...
        for i, memory in enumerate(memories):
            ...
            for term in negative_terms:
                if term in content_lower:
                    ...
                    scores[i] *= 0.01  # Reduce score to 1% of original
        ...
        for i, memory in enumerate(memories):
            ...
            for term in important_terms:
                if term in content_lower:
                    ...
                    original_score = scores[i]
                    scores[i] *= 5.0  # Apply 5x boost instead of 2x for memories with actual content
    ...
    def _boost_temporal_relevance(self, memories, scores, query):
        ...
        # Negative phrases that indicate empty responses
        negative_phrases = ["i don't recall", "i'm sorry", "no relevant", "haven't discussed", "don't remember"]
        ...
        for i, memory in enumerate(memories):
            ...
            for term in active_terms:
                if term in content_lower and not any(phrase in content_lower for phrase in negative_phrases): # Updated condition here
